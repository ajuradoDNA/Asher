...
public class Fabric extends Driver{
  ...
  public void AddFabric() throws Exception{
	  ...
	  action.moveToElement(we).moveToElement(driver.findElement(By.xpath("html/body/div[2]/div/div[1]/div[2]/div/div[1]/div/div/div/div/div/ul/li[8]/ul/li[1]/a"))).click().build().perform();
	  
	  Thread.sleep(3000);
	  
	  String title = driver.findElement(By.xpath("html/body/div[2]/div/div[3]/div/div[2]/div[2]/div/div/div[1]/h3")).getText();
	  ss.assertEquals("Fabric Color", title);
	  ...
	  ss.assertEquals("Fabric Colors", title2);
	  ...
	  driver.findElement(By.xpath("//*[@id='fabric-color-form']/div/div/div/div/div[2]/div/div[3]/ul/li[1]/label/span[1]")).click();
	  String val1 = driver.findElement(By.xpath("//*[@id='fabric-color-form']/div/div/div/div/div[2]/div/div[3]/ul/li[1]/label/span[2]")).getText();
	  driver.findElement(By.xpath("//*[@id='fabric-color-form']/div/div/div/div/div[2]/div/div[3]/ul/li[2]/label/span[1]")).click();
	  String val2 = driver.findElement(By.xpath("//*[@id='fabric-color-form']/div/div/div/div/div[2]/div/div[3]/ul/li[2]/label/span[2]")).getText();
	  ...
	  ss.assertEquals(fabColor+" already exist", msg2);
	  ...
	  Reporter.log("Fabric Color sauccessfully added.");
  ...
  public void EditFabric() throws Exception{
	  ...
	  boolean checkSelected1 = elementHasClass(driver.findElement(By.xpath("//*[@id='fabric-color-form']/div/div/div/div/div[2]/div/div[3]/ul/li[1]/label/span[1]/span")), "icon icon-fontello-check");
	  boolean checkSelected2 = elementHasClass(driver.findElement(By.xpath("//*[@id='fabric-color-form']/div/div/div/div/div[2]/div/div[3]/ul/li[2]/label/span[1]/span")), "icon icon-fontello-check");
	  ...
	  Reporter.log("Fabric Color sauccessfully edited.");
  ...
  public void DeleteFabric() throws Exception{
	  ...
	  Reporter.log("Fabric Color sauccessfully deleted.");
